...
<head>
    ...
    <title>Real Madrid Local 24/25 - JerseyZone</title>
    ...
    <main>
        <div class="product-detail">
            <div class="product-image-container">
                <img src="../img/Jerseys/RealMadridLocal.jpg" alt="Barcelona Jersey" class="product-image" id="mainImage" loading="lazy">
                <div class="product-thumbnails">
                    <img src="../img/Jerseys/RealMadridLocal.jpg" alt="Barcelona Jersey Front" class="thumbnail active" onclick="changeImage(this)" loading="lazy">
                    <img src="../img/Jerseys/RealM2.png" alt="Barcelona Jersey Back" class="thumbnail" onclick="changeImage(this)" loading="lazy">
                    <img src="../img/Jerseys/RealM3.png" alt="Barcelona Jersey Detail" class="thumbnail" onclick="changeImage(this)" loading="lazy">
                </div>
            </div>
            <div class="product-info">
                <h1 class="product-title">Real Madrid Local 24/25</h1>
                <p class="product-price" data-product-id="real_madrid">$ <?php echo $price; ?></p>
                <script>
                document.addEventListener('DOMContentLoaded', function() {
