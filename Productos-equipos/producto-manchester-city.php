...
<head>
    ...
    <title>Manchester City Local 24/25 - JerseyZone</title>
    ...
    <main>
        <div class="product-detail">
            <div class="product-image-container">
                <img src="../img/Jerseys/ManchesterCity.png" alt="Barcelona Jersey" class="product-image" id="mainImage" loading="lazy">
                <div class="product-thumbnails">
                    <img src="../img/Jerseys/ManchesterCity.png" alt="Barcelona Jersey Front" class="thumbnail active" onclick="changeImage(this)" loading="lazy">
                    <img src="../img/Jerseys/ManchsterC2.png" alt="Barcelona Jersey Back" class="thumbnail" onclick="changeImage(this)" loading="lazy">
                    <img src="../img/Jerseys/ManchesterC3.webp" alt="Barcelona Jersey Detail" class="thumbnail" onclick="changeImage(this)" loading="lazy">
                </div>
            </div>
            <div class="product-info">
                <h1 class="product-title">Manchester City Local 24/25</h1>
                <p class="product-price" data-product-id="manchester_city">$ <?php echo $price; ?></p>
                <script>
                document.addEventListener('DOMContentLoaded', function() {
