...
<head>
    ...
    <title>Tigres Local 24/25 - JerseyZone</title>
    ...
    <main>
        <div class="product-detail">
            <div class="product-image-container">
                <img src="../img/Jerseys/TigresLocal.jpg" alt="Tigres Jersey" class="product-image" id="mainImage" loading="lazy">
                <div class="product-thumbnails">
                    <img src="../img/Jerseys/TigresLocal.jpg" alt="Tigres Jersey Front" class="thumbnail active" onclick="changeImage(this)" loading="lazy">
                    <img src="../img/Jerseys/Tigres2.jpg" alt="Tigres Jersey Back" class="thumbnail" onclick="changeImage(this)" loading="lazy">
                    <img src="../img/Jerseys/Tigres3.jpg" alt="Tigres Jersey Detail" class="thumbnail" onclick="changeImage(this)" loading="lazy">
                </div>
            </div>
            <div class="product-info">
                <h1 class="product-title">Tigres Local 24/25</h1>
                <p class="product-price" data-product-id="tigres">$ <?php echo $price; ?></p>
                <script>
                document.addEventListener('DOMContentLoaded', function() {
