...
<head>
    ...
    <title>JerSix - Ac Milan 24/25</title>
    ...
    <main>
        <div class="product-detail">
            <div class="product-image-container">
                <img src="../img/Jerseys/MilanLocal.png" alt="Barcelona Jersey" class="product-image" id="mainImage" loading="lazy">
                <div class="product-thumbnails">
                    <img src="../img/Jerseys/MilanLocal.png" alt="Barcelona Jersey Front" class="thumbnail active" onclick="changeImage(this)" loading="lazy">
                    <img src="../img/Jerseys/Milan2.jpg" alt="Barcelona Jersey Back" class="thumbnail" onclick="changeImage(this)" loading="lazy">
                    <img src="../img/Jerseys/Milan3.png" alt="Barcelona Jersey Detail" class="thumbnail" onclick="changeImage(this)" loading="lazy">
                </div>
            </div>
