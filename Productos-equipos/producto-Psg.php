...
<head>
    ...
    <title>PSG Local 24/25 - JerseyZone</title>
    ...
    <main>
        <div class="product-detail">
            <div class="product-image-container">
                <img src="../img/Jerseys/PSGLocal.jpg" alt="PSG Jersey" class="product-image" id="mainImage" loading="lazy">
                <div class="product-thumbnails">
                    <img src="../img/Jerseys/PSGLocal.jpg" alt="PSG Jersey Front" class="thumbnail active" onclick="changeImage(this)" loading="lazy">
                    <img src="../img/Jerseys/Psg2.jpg" alt="PSG Jersey Back" class="thumbnail" onclick="changeImage(this)" loading="lazy">
                    <img src="../img/Jerseys/PSG3.png" alt="PSG Jersey Detail" class="thumbnail" onclick="changeImage(this)" loading="lazy">
                </div>
            </div>
            <div class="product-info">
                <h1 class="product-title">PSG Local 24/25</h1>
                <p class="product-price" data-product-id="psg">$ <?php echo $price; ?></p>
                <script>
                document.addEventListener('DOMContentLoaded', function() {
