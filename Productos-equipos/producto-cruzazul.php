...
<head>
    ...
    <title>Cruz Azul Local 24/25 - JerseyZone</title>
    ...
    <main>
        <div class="product-detail">
            <div class="product-image-container">
                <img src="../img/Jerseys/CruzAzulLocal.jpg" alt="Cruz Azul Jersey" class="product-image" id="mainImage" loading="lazy">
                <div class="product-thumbnails">
                    <img src="../img/Jerseys/CruzAzulLocal.jpg" alt="Cruz Azul Front" class="thumbnail active" onclick="changeImage(this)" loading="lazy">
                    <img src="../img/Jerseys/CruzAzul2.png" alt="Cruz Azul Jersey Back" class="thumbnail" onclick="changeImage(this)" loading="lazy">
                    <img src="../img/Jerseys/CruzAzul3.png" alt="Cruz Azul Jersey Detail" class="thumbnail" onclick="changeImage(this)" loading="lazy">
                </div>
            </div>
            <div class="product-info">
                <h1 class="product-title">Cruz Azul Local 24/25</h1>
                <p class="product-price" data-product-id="cruz_azul">$ <?php echo $price; ?></p>
                <script>
                document.addEventListener('DOMContentLoaded', function() {
